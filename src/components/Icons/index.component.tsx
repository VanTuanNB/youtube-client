...
export const LostConnectionSvg = ({ width = '100%', height = '100%', className }: IIconPropsComponent) => (
    <svg
        viewBox="0 0 192 195"
        preserveAspectRatio="xMidYMid meet"
        focusable="false"
        className={className}
        style={{ pointerEvents: 'none', display: 'block', width, height }}
    >
        <g viewBox="0 0 192 195" xmlnsXlink="http://www.w3.org/1999/xlink" className="style-scope yt-icon">
            <defs className="style-scope yt-icon"></defs>
            <g fill="none" fillRule="evenodd" className="style-scope yt-icon">
                <path
                    ...
                    className="style-scope yt-icon"
                ></path>
                <g transform="translate(0 -.341)" className="style-scope yt-icon">
                    <path
                ...
                <path
                    ...
                    className="style-scope yt-icon"
                ></path>
                <path fill="#FFF" d="M148.02 63.81l-18.033 1.087 17.456 2.105z" className="style-scope yt-icon"></path>
                <path
                ...
                <path
                    ...
                    className="style-scope yt-icon"
                ></path>
                <g transform="translate(65 .659)" className="style-scope yt-icon">
                    <path
